...
import com.rkarp.adminserver.service.UserServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/api/**").permitAll()                 //rest endpoints
                .antMatchers("/documentation/**").hasRole("ADMIN")  //swagger documentation
