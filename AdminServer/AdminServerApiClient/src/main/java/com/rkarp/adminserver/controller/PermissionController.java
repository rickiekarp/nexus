...
import com.rkarp.adminserver.service.PermissionService;
import com.rkarp.adminserver.service.RoleService;
...
public class PermissionController {
    ...
    @PreAuthorize("hasAnyAuthority('CTRL_PERM_LIST_GET','CTRL_PERM_EDIT_GET')")
    public List<Role> getAllRoles() {
        return roleService.getRoles();
    }

    @RequestMapping(value = {"/", "/list"}, method = RequestMethod.GET)
    @PreAuthorize("hasAuthority('CTRL_PERM_LIST_GET')")
    ...
    @PreAuthorize("hasAuthority('CTRL_PERM_ADD_POST')")
    ...
    @PreAuthorize("hasAuthority('CTRL_PERM_EDIT_POST')")
    ...
    @PreAuthorize("hasAuthority('CTRL_PERM_EDIT_GET')")
    ...
    @PreAuthorize("hasAuthority('CTRL_PERM_DELETE_GET')")
