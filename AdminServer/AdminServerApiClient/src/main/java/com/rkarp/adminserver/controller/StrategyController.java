...
import com.rkarp.adminserver.service.StrategyService;
...
public class StrategyController {
    ...
    @PreAuthorize("hasAuthority('CTRL_STRATEGY_LIST_GET')")
    ...
    @PreAuthorize("hasAuthority('CTRL_STRATEGY_ADD_POST')")
    ...
    @PreAuthorize("hasAuthority('CTRL_STRATEGY_EDIT_GET')")
    ...
    @PreAuthorize("hasAuthority('CTRL_STRATEGY_EDIT_POST')")
    ...
    @PreAuthorize("hasAuthority('CTRL_STRATEGY_DELETE_GET')")
