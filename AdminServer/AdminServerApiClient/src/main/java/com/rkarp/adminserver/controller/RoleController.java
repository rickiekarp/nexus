...
public class RoleController {
    ...
    @PreAuthorize("hasAuthority('CTRL_ROLE_LIST_GET')")
    ...
    @PreAuthorize("hasAuthority('CTRL_ROLE_ADD_POST')")
    ...
    @PreAuthorize("hasAuthority('CTRL_ROLE_EDIT_GET')")
    ...
    @PreAuthorize("hasAuthority('CTRL_ROLE_EDIT_POST')")
    ...
    @PreAuthorize("hasAuthority('CTRL_ROLE_DELETE_GET')")
