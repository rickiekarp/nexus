...
import com.rkarp.admin.view.reports.ReportEditor.PaletteItemType;
import com.rkarp.admin.view.reports.ReportEditor.ReportEditorListener;
...
public final class ReportsView extends TabSheet implements View, CloseHandler, ReportEditorListener {
    ...
    private static final String CONFIRM_DIALOG_ID = "confirm-dialog";
