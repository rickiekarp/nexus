package com.rkarp.admin.view.reports;

import java.text.SimpleDateFormat;
import java.util.Collection;
import java.util.Iterator;

import com.rkarp.admin.component.InlineTextEditor;
import com.rkarp.admin.component.TopTenMoviesTable;
import com.rkarp.admin.component.TransactionsListing;
...
public final class ReportEditor extends VerticalLayout {
    ...
    public enum PaletteItemType {
        TEXT("Text Block", VaadinIcons.FONT), TABLE("Top 10 Movies",
                ...
                VaadinIcons.BAR_CHART_H), TRANSACTIONS(
