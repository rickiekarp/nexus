package com.rkarp.admin.view.dashboard;
...
import com.rkarp.admin.component.TopTenMoviesTable;
import com.rkarp.admin.domain.DashboardNotification;
import com.rkarp.admin.view.dashboard.DashboardEdit.DashboardEditListener;
...
public final class DashboardView extends Panel implements View, DashboardEditListener {
    ...
    private Component buildHeader() {
        ...
        Button showWelcomeNotification = new Button("Show Notification");
        showWelcomeNotification.addClickListener((ClickListener) event -> {
            Notification notification = new Notification("Welcome to Dashboard");
        ...
        Button button = new Button("Add DashboardNotification");
        button.addClickListener((ClickListener) event -> {
            DashboardNotification n1 = new DashboardNotification();
            n1.setId(3);
            n1.setFirstName("sdfsdfgdxcf");
            n1.setLastName("dfkgjkndfljkg");
            n1.setAction("created a new report");
            n1.setPrettyTime("25 minutes ago");
            n1.setContent("sdfsdfasdfa");

            FrontendUI.getDataProvider().addNotification(n1);
            DashboardEventBus.post(new DashboardEvent.NotificationsCountUpdatedEvent());
        });

        Component edit = buildEditButton();

        HorizontalLayout tools = new HorizontalLayout(showWelcomeNotification, button, notificationsButton, edit);
...
//    }
    ...
    private void openNotificationsPopup(final ClickEvent event) {
        ...
        Collection<DashboardNotification> notifications = FrontendUI.getDataProvider().getNotifications();
        DashboardEventBus.post(new DashboardEvent.NotificationsCountUpdatedEvent());
        ...
        if (notificationsWindow == null) {
            ...
            notificationsWindow.setWidth(400.0f, Unit.PIXELS);
    ...
    public static final class NotificationsButton extends Button {
        ...
        public void updateNotificationsCount(final DashboardEvent.NotificationsCountUpdatedEvent event) {
            setUnreadCount(FrontendUI.getDataProvider()
