...
import com.rkarp.admin.component.ProfilePreferencesWindow;
import com.rkarp.admin.domain.Transaction;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private static final String NOTIFICATIONS_BADGE_ID = "dashboard-menu-notifications-badge";
    ...
    private Component buildTitle() {
        Label logo = new Label("<strong>Admin Tool</strong>",
                ContentMode.HTML);
            ...
            if (view == DashboardViewType.REPORTS) {
                ...
                reports.setDropHandler(new DropHandler() {
                    ...
                    public void drop(final DragAndDropEvent event) {
                        ...
                        Grid table = (Grid) event.getTransferable()
                                .getSourceComponent();
                        DashboardEventBus.post(new DashboardEvent.TransactionReportEvent(
                                (Collection<Transaction>) table.getData()));
                    }
    ...
    public void updateNotificationsCount(
        ...
        int unreadNotificationsCount = FrontendUI.getDataProvider()
