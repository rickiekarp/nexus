package com.rkarp.admin.view.schedule;

import com.google.common.eventbus.Subscribe;
import com.rkarp.admin.FrontendUI;
import com.rkarp.admin.component.MovieDetailsWindow;
...
//    private Calendar calendar;
    ...
    private void injectMovieCoverStyles() {
        ...
        String styles = "";
        for (Movie m : FrontendUI.getDataProvider().getMovies()) {
...
//        calendar.setEndDate(initialView.getTime());
    ...
    private Component buildCatalogView() {
        ...
        for (final Movie movie : FrontendUI.getDataProvider().getMovies()) {
...
//            // when needed.
//            Collection<Transaction> transactions = FrontendUI.getDataProvider()
//                    .getTransactionsBetween(startDate, endDate);
//            List<CalendarEvent> result = new ArrayList<CalendarEvent>();
//            for (Transaction transaction : transactions) {
//                Movie movie = FrontendUI.getDataProvider()
