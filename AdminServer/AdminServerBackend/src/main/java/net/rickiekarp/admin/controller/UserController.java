...
//
//import net.rickiekarp.admin.dao.UserDTO;
...
//import net.rickiekarp.admin.service.RoleService;
//import net.rickiekarp.admin.service.UserService;
...
//    @PreAuthorize("hasAnyAuthority('CTRL_USER_LIST_GET','CTRL_USER_EDIT_GET')")
...
//    @PreAuthorize("hasAuthority('CTRL_USER_ADD_POST')")
...
//    @PreAuthorize("hasAuthority('CTRL_USER_EDIT_GET')")
...
//    @PreAuthorize("hasAuthority('CTRL_USER_EDIT_POST')")
...
//    @PreAuthorize("hasAuthority('CTRL_USER_DELETE_GET')")
