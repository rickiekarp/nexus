...
import com.rkarp.addon.messagebox.icons.ButtonIconFactory;
import com.rkarp.addon.messagebox.icons.ClassicButtonIconFactory;
import com.rkarp.addon.messagebox.icons.DialogIconFactory;
import com.rkarp.addon.messagebox.icons.FlatDialogIconFactory;
...
public class MessageBox implements Serializable {
	 ...
	 */
	private static DialogIconFactory DIALOG_DEFAULT_ICON_FACTORY = new FlatDialogIconFactory();
	
	/**
	 * Keeps the icon default width and height
	 */
	private static String DIALOG_DEFAULT_ICON_SIZE = "48px";
	 ...
	 */
	private static boolean BUTTON_DEFAULT_ICONS_VISIBLE = true;
	
	/**
	 * If no button is added and this property is set to true (default), an close button is added.
	 */
	private static boolean BUTTON_ADD_CLOSE_PER_DEFAULT = true;
	 ...
	 */
	private String encodeToHtml(String plainText) {
	...
	private ButtonOption[] addOption(ButtonOption[] options, ButtonOption addOption) {
