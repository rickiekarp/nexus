package net.rickiekarp.shoppinghelper.fragments;
...
import net.rickiekarp.shoppinghelper.Constants;
import net.rickiekarp.shoppinghelper.ItemClickSupport;
import net.rickiekarp.shoppinghelper.R;
import net.rickiekarp.shoppinghelper.adapter.AdapterCustomRecyclerView;
import net.rickiekarp.shoppinghelper.communication.vo.VONotes;
import net.rickiekarp.shoppinghelper.db.AppDatabase;
import net.rickiekarp.shoppinghelper.dialog.NotesDialog;
import net.rickiekarp.shoppinghelper.interfaces.IOnAddNotesResult;
import net.rickiekarp.shoppinghelper.interfaces.IOnDialogClick;
...
import net.rickiekarp.shoppinghelper.model.CardViewItem;
import net.rickiekarp.shoppinghelper.provider.Notes;
import net.rickiekarp.shoppinghelper.tasks.AddNoteTask;
import net.rickiekarp.shoppinghelper.tasks.GetNotesTask;
import net.rickiekarp.shoppinghelper.tasks.RemoveNoteTask;
import net.rickiekarp.shoppinghelper.tasks.UpdateNoteTask;
